      ...
      <main class="main flex-grid col">
        ...
        <section class="main__content content home flex-grid--wrap col calign-top">
          ...
          <div class="flex-grid--row-rev--wrap col-12 calign-top mg-30--bottom">
            ...
            <!-- TITLE PAGE -->
            <h1 class="col light font-30 main-title is-sm">Oferta</h1>
          </div>
          <!-- /TOP -->
          ...
          <div class="flex-grid--wrap content__box--second nopadding col-12">
            ...
            <form class="form__maquinas form flex-grid--wrap col-12 pd-10" data-type-form="default" method="POST" action="/Parceiro/Oferta/Cadastrar">
              ...
              <div class="flex-grid--wrap col-12">
                ...
                <input class="input col-12" type="text" name="nm_oferta" maxlength="150" data-validate="empty" data-name="Referência" value="{{ old('nm_oferta') }}" required/>
              </div>
              <div class="flex-grid--wrap col-12 is-md">
                ...
                <textarea class="input col-12" name="ds_oferta" rows="7" maxlength="150" data-validate="empty" data-name="Descrição" required>{{ old('ds_oferta') }}</textarea>
              </div>
