        ...
        <div class="login__box">
          ...
          <form class="flex-grid--wrap login__form form shadow pd-20" action="" method="post">
            ...
            <div class="flex-grid--wrap form__box col-12">
              ...
              <input id="email" class="input--default input-nomargin col" type="text" name="email" data-validate="empty:email" data-name="E-mail" placeholder="E-mail ou Login" maxlength="100" />
            </div>
            <div class="flex-grid--wrap form__box col-12">
              ...
              <div class="flex-grid box-password col mg-10--bottom valign-top">
                <input id="password" class="input--default input-nomargin box-password__input col" type="password" name="password" data-validate="empty" data-name="Senha" maxlength="100" placeholder="Senha" />
