      ...
      <main class="main flex-grid col">
        ...
        <section class="main__content content home flex-grid--wrap col calign-top">
          ...
          <div class="flex-grid--wrap content__box--second nopadding col-12">
            ...
            @endif
            <form class="form__maquinas form flex-grid--wrap col-12 pd-10" data-type-form="default" method="POST" action="/Admin/Parceiro/Cadastrar">
              {{ csrf_field() }}
              <div class="flex-grid--wrap col-12">
                ...
                <input class="input col-12" maxlength="150" type="text" name="nm_parceiro" data-validate="empty" data-name="Nome Fantasia" required maxlength='150' value="{{ old('nm_parceiro', '') }}" required/>
              </div>
              <div class="flex-grid--wrap col-12">
                <span class="font-small bold mg-10--bottom">Email</span>
                <p class="font-small col-12 color-danger hidden" data-message="Email"></p>
                <input class="input col-12" maxlength="150" type="email" name="email" data-validate="empty" data-name="Email" required maxlength='100' value="{{ old('email', '') }}" required/>
              </div>
              <div class="flex-grid--wrap col-12">
                ...
                <input class="input col-12" type="text" maxlength="13" name="cd_telefone" data-validate="empty" data-name="Telefone" maxlength='13' required value="{{ old('cd_telefone', '') }}" required/>
              </div>
              <div class="flex-grid--wrap col-12">
                ...
                <input required id="pac-input" maxlength="100" class="input col-12" type="text" name="nm_endereco" maxlength="250" required value="{{ old('nm_endereco', '') }}" />
              </div>
