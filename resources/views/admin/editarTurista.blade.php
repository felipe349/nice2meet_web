          ...
          <div class="flex-grid--wrap content__box--second nopadding col-12">
            ...
            <form class="form__maquinas form flex-grid--wrap col-12 pd-10" data-type-form="default" action="/Admin/Turista/{{ $turista->id_turista }}" method="POST">
              ...
              <div class="flex-grid--wrap col-12">
                ...
                <input class="input col-12" disabled type="text" placeholder="exemplo@exemplo.com" data-validate="empty"  data-name="Email" maxlength="150" value="{{ $turista->nm_email_turista }}" /> 
              </div>
              ...
              <div class="flex-grid--wrap col-12">
                ...
                <input class="input col-12" name="dt_nascimento"  type="text" data-validate="empty"  data-name="Data de nascimento" maxlength="150" value="{{ $turista->dt_nascimento}}" /> 
              </div>
